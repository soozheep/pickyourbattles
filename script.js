const SITE_URL = 'https://pickyourbattles.vercel.app';
  ...
  if (navigator.share) {
    try {
      await navigator.share({
        title: 'Pick Your Battles — Sonic Remedy | Soozhee',
        text: 'Pick your battles, choose your fights. The ones that bring your heart to light. — Soozhee',
        url: SITE_URL
      });
      return;
    } catch (e) {}
